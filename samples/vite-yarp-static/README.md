...
![Screenshot of the Aspire Arcade CRT score counter served through YARP in the YARP Serving Static Files sample (light theme)](./images/vite-yarp-static-primary-page-light.png#gh-light-mode-only)
![Screenshot of the Aspire Arcade CRT score counter served through YARP in the YARP Serving Static Files sample (dark theme)](./images/vite-yarp-static-primary-page-dark.png#gh-dark-mode-only)
